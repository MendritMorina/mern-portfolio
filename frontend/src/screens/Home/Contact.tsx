...
const Contact = () => {
  ...
  const handleChange = (e: any) => {
    setSendEmailData({...sendEmailData, [e.target.name]: e.target.value});
  };
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      ...
      setSendEmailData({name: '', lastName: '', email: '', message: ''});
    } catch (error) {
    ...
    <div>
      ...
      <div className='flex gap-20 sm:flex-wrap sm:gap-10 sm:flex-col-reverse'>
        <div className='flex flex-col'>
          ...
          <p
            className='flex items-center text-white hover:text-tertiary hover:text-2xl hover:font-semibold mt-12 sm:mt-1'>
        ...
        <div className="w-full">
          <p className='text-white text-2xl lg:hidden sm:inline-block sm:mb-5'>Have an exciting project you need help
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <textarea id="message" name="message" rows={4} value={sendEmailData.message}
                        onChange={handleChange}

...
import {setSelectedItemIndex} from "../../redux/features/experience/experienceSlice";

//useSelector - Read the data
//useDispatch - Changing the data by sending "actions"
const Experiences = () => {
  const selectedItemIndex = useSelector((state: any) => state.experiences.selectedItemIndex);
      ...
      <div className='flex py-10 gap-20 sm:flex-col'>
        <div
          ...
          {experiences?.map((experience: any, index: any) => (
            <div key={index} onClick={() => dispatch(setSelectedItemIndex(index))} className='cursor-pointer'>
              <h1
